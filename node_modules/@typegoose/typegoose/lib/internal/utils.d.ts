 ...
 */
export declare function mergeSchemaOptions<U extends AnyParamConstructor<any>>(value: mongoose.SchemaOptions | undefined, cl: U): mongoose.SchemaOptions<any, IObjectWithTypegooseFunction, import("../types").BeAnObject, import("../types").BeAnyObject, import("../types").BeAnyObject, any, mongoose.Model<any, import("../types").BeAnObject, IObjectWithTypegooseFunction, import("../types").BeAnyObject, any, any, any>> | undefined;
/**
 ...
 */
export declare function mapArrayOptions(rawOptions: any, Type: AnyParamConstructor<any> | mongoose.Schema, target: any, pkey: string, modelOptions: IModelOptions, loggerType?: AnyParamConstructor<any>, extraInner?: KeyStringAny): mongoose.SchemaTypeOptions<any>;
/**
 * Map Options to "inner" & "outer"
 * @param rawOptions The raw options
 * @param Type The Type of the array
 ...
 * @param loggerType Type to use for logging
 */
export declare function mapOptions(rawOptions: any, Type: AnyParamConstructor<any> | (mongoose.Schema & IPrototype), target: any, pkey: string, modelOptions: IModelOptions, propType: PropType, loggerType?: AnyParamConstructor<any>): MappedInnerOuterOptions;
/**
 ...
 */
export declare function warnMixed(target: any, key: string, modelOptions: IModelOptions): void | never;
/**
