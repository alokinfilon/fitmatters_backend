 ...
 * ```
 */
export declare function plugin<TFunc extends Func, TParams extends Parameters<TFunc>[1] = Parameters<TFunc>[1]>(mongoosePlugin: TFunc, options?: TParams): ClassDecorator;
